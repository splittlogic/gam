...
class GamServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // $this->loadViewsFrom(__DIR__.'/../resources/views', 'gam');
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/gam.php', 'gam');

        // Register the service the package provides.
        $this->app->singleton('gam', function ($app) {
            return new Gam;
        });
    }
    ...
    protected function bootForConsole()
    {
        ...
        $this->publishes([
            __DIR__.'/../config/gam.php' => config_path('gam.php'),
        ], 'gam.config');
